# Generated by Django 3.1.5 on 2021-03-06 12:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addressID', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='PCStore.address')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.FileField(blank=True, upload_to='productImg/')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PCStore.productcategory')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.AddField(
            model_name='order',
            name='paymentID',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='PCStore.payment'),
        ),
        migrations.AddField(
            model_name='order',
            name='userID',
